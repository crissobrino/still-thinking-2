...
_JUDGE_MODEL    = "gemma2:9b"
_out_file       = f"automated_results_gemma_{METRIC}.csv"
...
# pipeline_cache.json is generated by evaluate_automated.py (llama3.1:8b pipeline).
# Run that script once with FORCE_REFRESH=True to populate it, then use it here.
